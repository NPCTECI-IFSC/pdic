...
urlpatterns = [
    ...
    url(r'^rotas/delete/(?P<pk>[0-9]+)/$', RotaDelete.as_view(), name='delete-rota'),
    ...
    url(r'^visoes/delete/(?P<pk>[0-9]+)/$', VisaoDelete.as_view(), name='delete-visao'),
    ...
    url(r'^fatores/delete/(?P<pk>[0-9]+)/$', FatorDelete.as_view(), name='delete-fator'),
    ...
    url(r'^responsaveis/delete/(?P<pk>[0-9]+)/$', ResponsavelDelete.as_view(), name='delete-responsavel'),
    ...
    url(r'^temas/delete/(?P<pk>[0-9]+)/$', TemaDelete.as_view(), name='delete-tema'),
    ...
    url(r'^acoes/delete/(?P<pk>[0-9]+)/$', AcaoDelete.as_view(), name='delete-acao')
]
